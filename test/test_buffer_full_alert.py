...
def test_buffer_full_alert():
    ...
    conveyor_1 = Conveyor(env, id="conveyor_1", capacity=3, position=(2, 0), mqtt_client=mqtt_client)
    conveyor_2 = Conveyor(env, id="conveyor_2", capacity=3, position=(2, 0), mqtt_client=mqtt_client)
    conveyor_3 = TripleBufferConveyor(env, id="conveyor_3", main_capacity=2, upper_capacity=1, lower_capacity=1, position=(2, 0), mqtt_client=mqtt_client)
